...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('assets/landing/images/LogoSod.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/a2hs.css') }}">
    <style>
      body {
  ...
  <body>
    ...
    <button class="add-button" style="display: none;">Tambahkan ke Layar Utama</button>
