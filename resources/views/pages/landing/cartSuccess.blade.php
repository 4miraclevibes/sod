...
<div class="d-flex flex-column min-vh-50">
    <div class="bg-white p-3">
        <div class="d-flex align-items-center">
            ...
            <p class="fs-5 m-auto py-2 mb-0">Keranjang Belanja</p>
        </div>
    </div>
    
    <div class="flex-grow-1 d-flex flex-column justify-content-center align-items-center p-4">
        <div class="mb-4 text-center">
            <img src="{{ asset('assets/landing/images/cart-success.png') }}" alt="Keranjang Kosong" class="img-fluid" style="max-width: 200px;">
        </div>
        <p class="fs-6 fw-semibold mb-1">Pesanan Berhasil Dibuat</p>
        <p class="fs-7 text-muted mb-4">Pesanan anda akan segera di proses</p>
